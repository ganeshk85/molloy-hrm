...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    private function getEthnicList() {
        $ethnicService = new EthnicService();
        $categories = $ethnicService->getEthnicList();
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            'cmbEmpTitle' => new sfWidgetFormSelect(array('choices' => array('' => "-- " . __('Select') . " --", 'Mr' => __('Mr'), 'Mrs' => __('Mrs'), 'Ms' => __('Ms'), 'Dr' => __('Dr'), 'Sr' => __('Sr')))),
            ...
            'txtEmpPrevLastName' => new sfWidgetFormInputText(),
            ...
            'txtEmpReligious' => new sfWidgetFormInputText(),
            'cmbEthnic' => new sfWidgetFormSelect(array('choices' => $this->getEthnicList())),
        );

        //setting default title
        $widgets['cmbEmpTitle']->setDefault($this->employee->emp_title);
        ...
        $widgets['txtEmpPrevLastName']->setAttribute('value', $this->employee->emp_prev_lastname);
        ...
        $widgets['txtEmpReligious']->setAttribute('value', $this->employee->emp_religious);
        
        //setting the default selected ethnicity
        $widgets['cmbEthnic']->setDefault($this->employee->emp_ethnic);
    ...
    private function getPersonalInfoValidators() {
        ...
        $validators = array(
            'cmbEmpTitle' => new sfValidatorString(array('required' => false)),
            ...
            'txtEmpPrevLastName' => new sfValidatorString(array('required' => false, 'trim' => true)),
            ...
            'txtEmpReligious' => new sfValidatorString(array('required' => false, 'trim' => true)),
            'cmbEthnic' => new sfValidatorChoice(array('required' => false, 'choices' => array_keys($this->getEthnicList())))
        );
    ...
    public function getEmployee() {
        ...
        if ($this->personalInformationPermission->canUpdate()) {
            ...
            $employee->emp_title = $this->getValue('cmbEmpTitle');
            ...
            $employee->emp_prev_lastname = $this->getValue('txtEmpPrevLastName');
            ...
            $employee->emp_religious = $this->getValue('txtEmpReligious');
            
            $ethnic = $this->getValue('cmbEthnic');
            $employee->emp_ethnic = ($ethnic != '0') ? $ethnic : null;
        }
