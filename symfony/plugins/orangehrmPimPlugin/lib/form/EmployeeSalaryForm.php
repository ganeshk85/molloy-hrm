...
class EmployeeSalaryForm extends BaseForm {
    ...
    public function getSalary() {
        ...
        $empSalary->setCreditsTaught($this->getValue('credits_taught'));
        $empSalary->setReducedCredit($this->getValue('reduced_credit'));
        $empSalary->setTotalCredits($this->getValue('total_credits'));
        $empSalary->setHours($this->getValue('hours'));
