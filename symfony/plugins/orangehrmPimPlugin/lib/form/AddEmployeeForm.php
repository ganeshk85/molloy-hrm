...
class AddEmployeeForm extends sfForm {
    ...
    public function configure() {
		...
		$emp_type = array('1' => __('Administrator'), '2' => __('Staff'), '3' => __('Faculty'), '4' => __('Adjunct'), '5' => __('Coach'), '6' => __('Intern'));
        ...
        $this->widgets = array(
            ...
            'department' => new sfWidgetFormSelect(array('choices' => $subDivisions)),
        ...
        $this->setValidators(array(
            ...
            'department' => new sfValidatorChoice(array('required' => false, 'choices' => array_keys($subDivisions))),
        ...
        $customRowFormats[10] = "<li class=\"loginSection\">%label%\n %field%%help%\n%hidden_fields%%error%</li>\n";
    ...
    protected function getFormLabels() {
        $labels = array(
            ...
            'eeo_category' => "Employment Category"
        );
    ...
    public function getEmployee(){
        ...
        $employee->work_station = $this->getValue('department');
    ...
    private function _getJobTitles() {
        ...
        foreach ($jobTitleList as $job) {
            if (($job->getIsDeleted() == JobTitle::ACTIVE)) {
