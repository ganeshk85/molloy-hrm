        ...
        <div class="inner">
            ...
            <form id="frmEmpPersonalDetails" method="post" action="<?php echo url_for('pim/viewPersonalDetails'); ?>">
                ...
                <fieldset>
                    ...
                    <ol>
                        <li>
                            <label for="personal_cmbEmpTitle"><?php echo __('Title'); ?></label>
                            <?php echo $form['cmbEmpTitle']->render(array("class"=>"editable")); ?>
                        </li>
                        ...
                        <li class="new">
                            <label for="personal_txtEmpPrevLastName"><?php echo __('Previous Last Name'); ?></label>
                            <?php echo $form['txtEmpPrevLastName']->render(array("class" => "editable", "maxlength" => 30)); ?>
                        </li>                    
                    </ol>
                    <ol>
                        <li>
                    ...
                    <ol>
                        ...
                        <li class="new">
                            <label for="personal_txtEmpReligious"><?php echo __('Religious'); ?></label>
                            <?php echo $form['txtEmpReligious']->render(array("class" => "editable", "maxlength" => 30)); ?>
                        </li>
                        <li class="new">
                            <label for="personal_cmbEthnic"><?php echo __("Ethnic"); ?></label>
                            <?php echo $form['cmbEthnic']->render(array("class"=>"editable")); ?>
                        </li>
