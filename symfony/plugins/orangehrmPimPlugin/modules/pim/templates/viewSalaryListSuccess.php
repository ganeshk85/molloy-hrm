            ...
            <form id="frmSalary" action="<?php echo url_for('pim/viewSalaryList?empNumber=' . $empNumber); ?>" method="post" class="longLabels">
                <fieldset>
                    ...
                    <ol>
                        ...
                        <li>
                            <?php echo $form['credits_taught']->renderLabel(__('Credits Taught') . ' <em>*</em>'); ?>
                            <?php echo $form['credits_taught']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
                        <li>
                            <?php echo $form['reduced_credit']->renderLabel(__('Reduced Credit') . ' <em>*</em>'); ?>
                            <?php echo $form['reduced_credit']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
                        <li>
                            <?php echo $form['total_credits']->renderLabel(__('Total Credits') . ' <em>*</em>'); ?>
                            <?php echo $form['total_credits']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
                        <li>
                            <?php echo $form['hours']->renderLabel(__('Hours') . ' <em>*</em>'); ?>
                            <?php echo $form['hours']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
